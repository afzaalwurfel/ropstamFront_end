...
<html lang="en">
  <head>
    ...
    <title>Ropstam | Account Login</title>
    <!-- Bootstrap core CSS -->
  ...
  <body><!-- the following Event ID for your records://CRO-7546-WHHQ -->
    ...
    <header id="header">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h1 class="text-center"> Ropstam <small>Account Login</small></h1>
          </div>
        </div>
      </div>
    </header>
        ...
        <div class="row">
          <div class="col-md-4 col-md-offset-4">
            <form id="login" action="" class="well">
                  ...
                  <button onclick="login(event);" type="submit" class="btn btn-default btn-block">Login</button>
              </form>
          </div>
        </div>
      </div>
