    ...
    <section id="main">
      <div class="container">
        <div class="row">
          ...
          <div class="alert alert-success  signupFormAlertDiv" style="display:none"
                                        role="alert"></div>
            <form id="signup_form" action="" class="well">
            ...
            <div class="form-group">
                  ...
                  <button onclick="signup(event);" type="submit" class="btn btn-default btn-block">sign Up</button>
